...
from ecoeye2.server.routes import analytics, econ_routes, health, pipeline, reporting, tables, uploads, ai_routes, forecast_routes, outlier_routes
...
_secured.include_router(outlier_routes.router, tags=["outliers"])
