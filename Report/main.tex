...
\author{
  Student: \textbf{Anas Amchaar} \\
  Supervisor: \textbf{Dr. [Supervisor Name]} \\
  Department: \textbf{Department of Mathematics and Computer Science}
}
...
\begin{titlepage}
  \centering
  {\Large Mohammed V University in Rabat}\\[0.4cm]
  {\large Faculty of Sciences}\\[1.4cm]
  ...
  \begin{tabular}{p{0.3\textwidth}p{0.6\textwidth}}
    Student: & Anas Amchaar \\
    Supervisor: & Dr. [Supervisor Name] \\
    Jury President: & Prof. [Jury President Name] \\
    Jury Member: & Prof. [Jury Member Name] \\
  \end{tabular}\\[1.5cm]
